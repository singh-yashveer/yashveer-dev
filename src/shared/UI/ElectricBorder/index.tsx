...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
  ...
  const updateAnim = () => {
    ...
    if (strokeRef.current) {
      strokeRef.current.style.filter = isActive ? `url(#${filterId})` : "none";
    }
  ...
  const bgGlowStyle: CSSProperties = {
    ...
    zIndex: -1,
    background: `radial-gradient(ellipse, ${hexToRgba(color, 0.6)}, transparent 70%)`,
    transition: "opacity 0.3s ease",
    borderRadius: "8px",
  };
